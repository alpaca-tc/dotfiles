...
hi Normal guifg=#bfbfbf guibg=#2b2b2b guisp=#2b2b2b gui=NONE ctermfg=7 ctermbg=234 cterm=NONE
...
hi Comment guifg=#5e7a5e guibg=NONE guisp=NONE gui=italic ctermfg=65 ctermbg=NONE cterm=NONE
