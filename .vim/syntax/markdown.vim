...
syn cluster markdownBlock contains=markdownH1,markdownH2,markdownH3,markdownH4,markdownH5,markdownH6,markdownBlockquote,markdownListMarker,markdownOrderedListMarker,markdownCodeBlock,markdownRule,markdownHR
...
syn match markdownHR "\(-\|- \)\{3,}$" contained
...
syn region markdownItalic start="\S\@<=\*\|\*\S\@="hs=s+1 end="\S\@<=\*\|\*\S\@="he=e-1 keepend contains=markdownLineStart
syn region markdownItalic start="\S\@<=_\|_\S\@="hs=s+1 end="\S\@<=_\|_\S\@="he=e-1 keepend contains=markdownLineStart
syn region markdownBold start="\S\@<=\*\*\|\*\*\S\@="hs=s+2 end="\S\@<=\*\*\|\*\*\S\@="he=e-2 keepend contains=markdownLineStart
syn region markdownBold start="\S\@<=__\|__\S\@="hs=s+2 end="\S\@<=__\|__\S\@="he=e-2 keepend contains=markdownLineStart
...
hi def link markdownHR                    markdownRule
