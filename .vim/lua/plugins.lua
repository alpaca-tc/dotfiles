...
require("lazy").setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function()
          ...
          vim.keymap.set("n", "<CR>", move_to_ddu_ff_and_cr, { noremap = true, buffer = true, silent = true })
          vim.keymap.set("i", "<CR>", move_to_ddu_ff_and_cr, { noremap = true, buffer = true, silent = true })
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-J>b", function()
  ...
  },
  {
    ...
    build = "make tiktoken && brew install git lynx",
    dependencies = {
    ...
    init = function()
      vim.keymap.set("x", "Q", function()
        ...
        chat.ask("コードの動作を説明してください。まず、コードの概要を端的に説明してください。その後に、上から順にどういう処理をしているか説明してください。最後に、このコードがどういった意図か、歴史的経緯や使われ方や関係を説明してください。", {
    ...
    config = function()
      ...
      chat.setup({
        ...
        system_prompt = [[
          ...
          Keep your answers short and impersonal in Japanese.
    ...
    init = function()
      ...
      vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function()
          ...
          if
              file_extend.file_match_str(root .. "/Gemfile", "ruby-lsp")
              or file_extend.file_match_str(root .. "/Gemfile", "smarthr-ruby-ls")
          then
  ...
  },
  {
    ...
    init = function()
      ...
      vim.g.switch_file_rules = {
        ...
        typescript = {
          { "%\\.ts", "__tests__/:basename_no_ext.test.ts", },
          { "__tests__/%.test.ts", "%\\.ts" },
          { "%\\.ts", "__tests__/:basename_no_ext-test.ts", },
          { "__tests__/%-test.ts", "%\\.ts" },
        },
      }
