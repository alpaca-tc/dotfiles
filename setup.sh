...
if [ $yn = "y" -o $yn = "Y" ]; then
    DOT_FILES=(.gitignore_global .ctags .dir_colors .gemrc .gitconfig .gitignore .inputrc .rspec .rvmrc .tmux.conf .tmux.split .zshrc .autojump .emacs.d .tmuxinator .vim .zsh local .pryrc .eskk .eskk_dict .tmux-powerlinerc .tmux .config .rubocop.yml)
